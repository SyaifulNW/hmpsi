        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="section-title text-center">
                    <h2 class="display-5 mb-5">Sekretaris</h2>
                </div>
                <div class="row g-4">
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="team-item">
                            <div class="overflow-hidden position-relative">
                                <img class="img-fluid" src="img/selvia.jpg" alt="">
                            ...
                            <div class="text-center border border-5 border-light border-top-0 p-4">
                                <h5 class="mb-0">Selfia Yustika Rini.</h5>
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="team-item">
                            ...
                            <div class="text-center border border-5 border-light border-top-0 p-4">
                                <h5 class="mb-0">Wanda Fadillah.</h5>
                                <small>Sekretaris</small>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="team-item">
                            <div class="overflow-hidden position-relative">
                                <img class="img-fluid" src="img/tyas.jpg" alt="">
                                <div class="team-social">
                                    <a class="btn btn-square" href=""><i class="fab fa-facebook-f"></i></a>
                                    <a class="btn btn-square" href=""><i class="fab fa-twitter"></i></a>
                                    <a class="btn btn-square" href=""><i class="fab fa-instagram"></i></a>
                            ...
                            <div class="text-center border border-5 border-light border-top-0 p-4">
                                <h5 class="mb-0">Dwi Wahyuningtyas.</h5>
                                <small>Sekretaris</small>
                            </div>
                        </div>
                    </div>
