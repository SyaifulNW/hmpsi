            ...
            <div class="wrap-login100 text-center">
                ...
                <form method="POST" action="{{route('login')}}" class="login100-form validate-form">
                    ...
                    <div class="login100-form-title d-flex justify-content-center">
                        <img class="d-flex mx-2 my-1" src="asset/img/Logo NGI.png" style="height: 40px;">
                        <img class="d-none d-sm-block mx-2 my-1" src="asset/img/Text ngi.png" style="height: 40px;">
                    </div>
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Valid email is required: ex@abc.xyz">
                        <input class="input100 form-control @error('email') is-invalid @enderror" type="text" id="name" name="name" value="{{ old('email') }}" placeholder="Username">
                        @error('email')
